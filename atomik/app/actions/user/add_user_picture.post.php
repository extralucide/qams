   ...
   (is_uploaded_file($_FILES['filename']['tmp_name'])))
{
	...
	if (!(in_array($extensionFichier, $extensionsAutorisees))) {
		...
		$info = array('maxSize'=>$maxSize,
						...
						'location'=>"atomik".DIRECTORY_SEPARATOR."assets".DIRECTORY_SEPARATOR."images".DIRECTORY_SEPARATOR."photos".DIRECTORY_SEPARATOR);				
...
Atomik::redirect('edit_user?edit_user_id='.$user_id);