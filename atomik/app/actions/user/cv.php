...
$html .= "<p><a href='".Atomik::url('edit_user',array('edit_user_id'=>$id))."'>".$user->getFullName()."</a></p>"; 
$html .= "<h3>Formation</h3>"; 
$html .= $user->getProperty(); 
$html .='<p><a href="'.Atomik::url("edit_user",array('edit_user_id'=>$id)).'" ><img src="'.Atomik::asset('assets/images/pages/sommaire.png').'" border="0" alt="Back" title="Back"><h2>Back</h2></a></p>';
