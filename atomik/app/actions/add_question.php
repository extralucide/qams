...
$list_table_upper_data_query = "SHOW TABLES  FROM olivier_appere LIKE '%table_upper_data_".$spec_id."%'";
$db= new Db("atomik");
$result = $db->db_query($list_table_upper_data_query); 
$nbtotal=mysql_num_rows($result);
if ($nbtotal == 0) {
	// create upper table
	$sql_query = "CREATE TABLE `olivier_appere`.`table_upper_data_".$spec_id."` (`id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY ,".
